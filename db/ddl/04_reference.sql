...
COMMENT ON COLUMN ref_static_allocation.as_of_date IS 'Effective date for this ratio. NULL matches any as_of_date.';
...
CREATE INDEX IF NOT EXISTS ix_ref_static_allocation_as_of_date      ON ref_static_allocation(as_of_date);
...
COMMENT ON COLUMN ref_org_reclass.as_of_date IS 'Effective date for this reclass. NULL matches any as_of_date.';
...
CREATE INDEX IF NOT EXISTS ix_ref_org_reclass_as_of_date      ON ref_org_reclass(as_of_date);
...
COMMENT ON COLUMN ref_static_distribution.as_of_date  IS 'Effective date for this distribution. NULL matches any as_of_date.';
...
CREATE INDEX IF NOT EXISTS ix_ref_static_distribution_as_of_date      ON ref_static_distribution(as_of_date);
...
COMMENT ON COLUMN ref_static_alloc.as_of_date IS 'Effective date for this static alloc. NULL matches any as_of_date.';
...
CREATE INDEX IF NOT EXISTS ix_ref_static_alloc_as_of_date      ON ref_static_alloc(as_of_date);
